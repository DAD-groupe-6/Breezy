...
export default function PostMenu({ isMine, canModerate, canReport = true, isAuthorBanned, alreadyReported, onViewProfile, onEdit, onReport, onDelete, onBanAuthor, onUnbanAuthor }) {
    ...
    <div className="relative shrink-0" ref={ref}>
      ...
      {open && mounted && createPortal(
        ...
        >
          ...
          {isMine && (
            <button
              className={`${itemClass} text-[var(--color-text-primary)] border-t border-[var(--color-border)]`}
