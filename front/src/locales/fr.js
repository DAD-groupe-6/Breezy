const fr = {
  ...
  pages: {
    ...
    settings: {
      ...
      adminDescription: 'Gérez les rôles et les permissions de la plateforme.',
      adminLink: 'Ouvrir le panneau d’administration',
    ...
    admin: {
      ...
      subtitle: 'Gérez les rôles et les permissions de la plateforme.',
      loading: 'Chargement...',
      ...
      permissionName: 'Nom (technique)',
      permissionDescription: 'Description',
      permissionsLabel: 'Permissions accordées',
      noPermissions: 'Aucune permission disponible.',
      coreRoleHint: 'Rôle système (non supprimable / non renommable)',
      ...
      deletePermissionConfirm: {
        ...
        message: 'Voulez-vous vraiment supprimer cette permission ? Elle sera retirée de tous les rôles.',
        confirm: 'Supprimer',
        cancel: 'Annuler',
      },
    },
    newPost: {
      ...
      dropPhoto: 'Déposez votre photo ici',
      dropVideo: 'Déposez votre vidéo ici',
      dropHintPhoto: 'ou cliquez sur le bouton Photo pour sélectionner un fichier',
      dropHintVideo: 'ou cliquez sur le bouton Vidéo pour sélectionner un fichier',
